          ...
          <div class="card-body">
              @foreach($game->reviews as $review)
                ...
                <small class="text-muted">Posted by {{ $review->auteur }} on {{ $review->created_at }} 
                    ...
                    <a href="" src="https://img.icons8.com/fluent-systems-filled/17/000000/border-color.png">
                    <a href="" src="https://img.icons8.com/fluent-systems-filled/17/000000/xbox-x.png">
                @endif
